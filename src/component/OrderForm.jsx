  ...
  return (
    <div className='form_container'>
        <div className='form_content'>
                   ...
                   <div className='form_inputs'>
                    ...
                    <div className='phone'>
                        ...
                        <div className='numrow'>
                            ...
                            <input type='number' placeholder='Local' />
                            <input type='number' placeholder='Local' />
                        </div>
                    </div>
                    ...
                    <div className='pizza_size'>
                        <p>Pizza Size</p>
                        <input type='radio' id='8-inch' name='pizza'/>
                        &nbsp;
            ...
            <Button className='order_now_button' variant="contained" onClick={() => navigate("/sucess")}>Order Now</Button>
            </div>
        </div>
    </div>
  )
