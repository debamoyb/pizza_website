    ...
    {products && products.map(ele => {
        return(
            <div className='pizza_box' key={ele.id}>
                ...
                <Button className='button add_cart_button' variant="contained" onClick={() => navigate("/orderform")}>ADD TO CART</Button>
    ...
    {flag ? (
        <div className='react_modal'>
                    <ReactModal
                        ...
                        style={{content: {position: 'absolute',top: '50%',left: '50%',transform: 'translate(-50%, -50%)',},overlay: {backgroundColor: 'rgba(0, 0, 0, 0.5)',},}}>
